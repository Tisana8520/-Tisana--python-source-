...
string = "aThe Quick Brown For Jump Over The Lazy Dog"

print("=== TEXT ANALYSIS REPORT ===")
print("Charactor Analysis")
print("- Total charactor: %d (with spaces) %d (witout space)" %(len(string), len(string)-string.count(" ")))
